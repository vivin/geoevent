...
public:
	...
	void Generate_Parallel_CTMINEPI(string eList, int min_fr, int& k, int wina, int winc, const event_set& A, const event_set& C, char type, string &epCntsXML);
	...
	void Generate_Serial_CTMINEPI(string eList, int min_fr, int& k, int wina, int winc, const event_set& A, const event_set& C, char type, int sources, const event_vec_vec& TimeFvec, string &epCntXML);
